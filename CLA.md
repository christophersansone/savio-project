...
3. **You retain ownership.** You keep the copyright in your contribution and may use it however you wish. This is a license, not an assignment.

4. **Attribution.** The steward will credit you by name (or your chosen handle) in the project's contributor records, permanently, unless you request otherwise.

5. **Your representations.** The contribution is your original work (or you have the right to submit it under these terms); it does not knowingly infringe anyone's rights; and if you created it in the course of employment, you have your employer's permission or the work falls outside their claim.

6. **No warranty; no obligation.** You provide the contribution "as is." The steward is not obligated to use or include any contribution.

7. **The steward's obligations to you** are the public promises of the [Stewardship Commitment](docs/stewardship-commitment.md), including: the mission stays free for families; public license terms are never tightened retroactively; and if the project winds down, core content is released under an open license.

**To agree:** include this line in your pull request description — `I have read and agree to the Contributor License Agreement (CLA.md).`
