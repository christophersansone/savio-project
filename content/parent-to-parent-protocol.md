...
*The Savio Standard · Working draft · The full guide — a printable quick-reference card is at the end*
...
> Instead of: *"Your daughter has been really mean to Clara."*
> Say: *"On Tuesday, a group chat started that Clara was left out of, and some of the messages were about her. She's been coming home in tears. I have the screenshots if you want to see them — and I want to say up front, I only know my daughter's side."*
...
4. What is said in the room stays in the room. No exceptions but the safeguarding boundaries below.
5. The meeting ends with agreements written down — even small ones — and a follow-up date.
